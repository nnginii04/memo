...
insert into major values ('m2', '노드', '오승혁');
insert into major values ('m3', '플라스크', '홍길동');
insert into major values ('m4', '루비온레일즈', '김성실');
insert into major values ('m5', '라라벨', '이개그');
insert into major values ('m6', '리액트', '김피곤');
insert into major values ('m7', '뷰', '이차차');
insert into major values ('m8', '앵귤러', '박호호');

desc student;

insert into student values ('s1', '최원빈', '20100101', 'M','01001001001', 'm1');
...
INSERT INTO STUDENT(student_code, name, gender, major_code, birth, phone) VALUES('s14', '김동현', 'M', 'm4', '20030202', '01000000020'),
                                                                                ('s15', '박은진', 'F', 'm3', '20221101','01001001010');
...
insert into student values ('s0', '안될애', '20202020', 'M', '01092929292', 'm1');
...
-- ON 절을 사용하여 조인조건을 지정한다.
-- 가독성이 좋고, 복잡한 조인 조건을 명확하게 표햔할 수 있기 때문
...
#학교홈페이지 vs. 쿠팡
#"조치원읍 210번길 213-2"
#"조치원읍", "210번길", "213", "2", addr1, addr2, street, unit, postcode
